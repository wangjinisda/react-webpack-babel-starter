import { IDataItem, IDetailInformation, ISearchResult, IPrice, IStartingPrice, ITestDriveItem } from '../shared/Models';
import { PlanPricingType, OS } from './utils/constants';
