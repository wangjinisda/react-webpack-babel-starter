...
import { IAppDataItem, IPartnerDataItem, IVideo, ITelemetryData, IReviewPayload, IDrive, IFieldHub, IDisclaimer } from './../../Models';
import { IUserDataState } from '../../../state';
import { IBuildHrefContext, ICommonContext } from '../../interfaces/context';
import { urlReplace, routes, appendQueryParams } from '../../routerHistory';
...
import { handleConsentModalCall } from './../../../mac/handlers/consentModalHandler';
