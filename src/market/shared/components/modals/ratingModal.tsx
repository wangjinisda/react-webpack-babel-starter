...
import { ITelemetryData, IUserReview, IReviewPayload } from '../../Models';
                            ...
                            <div className='section2'>
                                ...
                                <div className='reviewContainer'>
                                    ...
                                    <div className='c-textarea'>
                                        <label className='c-label topMessage' htmlFor='default-textarea-2'>{this.context.loc('Rating_ReviewDetail', 'Review details')}</label>
