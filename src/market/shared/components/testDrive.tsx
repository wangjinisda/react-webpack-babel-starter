...
import { shouldPollForTestDrive } from './../../mac/utils/testdriveConfig';
...
export class TestDrive extends SpzaComponent<ITestDriveProps, ITestDriveState> {
    ...
    navigateToTestDrive(): void {
        ...
        let output = this.state.testDriveInstance.outputs.filter((item) => item.type.toLowerCase() === Constants.TestDriveOutputType.HandOffUrl);
